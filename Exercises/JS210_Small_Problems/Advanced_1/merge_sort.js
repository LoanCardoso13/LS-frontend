/*
  ...
  In the first step, we partition the array into an array of two sub-arrays, so that each sub-array contains approximately half of the entries. In the next step, we partition each sub-array in the same way. This process repeats until each of the innermost sub-arrays contains exactly one element.
...
console.log(merge_sort([9, 2, 7, 6, 8, 5, 0, 1])); // [0, 1, 2, 5, 6, 7, 8, 9])
